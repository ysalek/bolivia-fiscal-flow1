...
const EnhancedLayout = ({ children }: EnhancedLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      {/* Barra de estado PWA - z-index reducido para no interferir con notificaciones */}
      <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-slate-200 dark:bg-slate-900/80 dark:border-slate-700">
              ...
              <div className="flex items-center gap-1.5">
                {isOnline ? (
                  <>
                    ...
                    <Badge variant="outline" className="text-xs text-green-700 border-green-200 px-2 py-0.5">
                      En línea
                    </Badge>
                  </>
                ) : (
                  <>
                    ...
                    <Badge variant="destructive" className="text-xs text-red-700 px-2 py-0.5">
                      Sin conexión
                    </Badge>
                  </>
                )}
